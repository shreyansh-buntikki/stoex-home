...
export const EarlyAccess = () => {
  return (
    <section className="bg-white  py-[90px] pb-0 px-0">
      <div className="mx-auto border-1 border-top-[#CCA76333] w-full max-w-none">
        <div className="relative w-full overflow-hidden bg-[#fff] px-6 py-12 md:px-12 md:py-16">
          ...
          <div className="pointer-events-none absolute inset-y-0 right-0 w-[48%]">
            <Image
              ...
              fill
              sizes="50vw"
              className="scale-x-[-1] object-cover object-right opacity-80"
            />
          </div>
          ...
          <div className="relative z-10 mx-auto max-w-[900px] pt-20 text-center">
            ...
            >
              ...
              permanently immutable gold - starting from ₹15
            </h2>
            ...
            <p
              ...
              style={mona}
            >
              Join the waitlist and get exclusive early access when we launch in April 2026
            </p>
            ...
            <p className="mt-4 text-[16px] leading-none" style={mona}>
              ...
              <span className="text-[#767676]">people already on the waitlist</span>
            </p>
            ...
            <div className="mt-6 flex flex-wrap pb-20 items-center justify-center gap-x-5 gap-y-2">
              {benefits.map((item) => (
                <div key={item} className="inline-flex items-center gap-2">
                  ...
                  <span className="text-[14px] leading-[20px] text-[#5A5A5A]" style={mona}>
                    {item}
                  </span>
                </div>
              ))}
