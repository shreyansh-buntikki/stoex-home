...
export default function EarlyAccessModal({ open, setOpen }: Props) {
  ...
  const validateForm = () => {
    ...
    Object.assign(errors, nameErrors, emailErrors, phoneErrors, messageErrors);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const result = await sendEarlyAccessEmail(formData);
  ...
  const handleBlur = (fieldName: string) => {
    ...
    const errors = validateField(fieldName, formData[fieldName as keyof typeof formData]);
  ...
  return createPortal(
    ...
    >
      ...
      <div
        ...
        className="relative z-10 w-full max-w-lg max-h-[90vh] overflow-y-auto rounded-xl sm:rounded-2xl bg-white p-5 sm:p-6 md:p-8 shadow-2xl custom-scrollbar"
        style={{
          scrollbarWidth: 'auto',
      ...
      >
        ...
        >
          Be among the first to experience our upcoming release. Sign up to get
          early access, product updates, and exclusive insights before we launch
          publicly.
        </p>
